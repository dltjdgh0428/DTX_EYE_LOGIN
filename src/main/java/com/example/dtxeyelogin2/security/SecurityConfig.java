package com.example.dtxeyelogin2.security;

import com.example.dtxeyelogin2.service.CustomOAuth2UserService;
...
//                .and()//위의 한줄은  서버 측 세션을 사용하지 않겠다는 것을 설정합니다.
                .authorizeHttpRequests()//여기부터 HTTP 요청에 대한 보안 규칙을 정의하기 시작합니다.
                .requestMatchers("/login").permitAll() // "/login" 경로로 들어오는 요청에 대해 인증을 거치지 않겠다는 것을 설정합니다.
